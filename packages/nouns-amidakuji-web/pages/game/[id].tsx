...
const Id: NextPage<{}> = () => {
  ...
  const { image, result, currentGameId, isHeld } = useAmidakujiResult(
              ...
              <Col>
                <Arrows
                  leftProps={{
                    onClick: () => {
                      if (id && parseInt(id) > 1) {
                        location.href = `/game/${parseInt(id) - 1}`;
                      }
                    },
                  ...
                  rightProps={{
                    onClick: () => {
                      if (
                        ...
                        currentGameId &&
                        currentGameId ===
                          (isHeld ? parseInt(id) + 1 : parseInt(id))
                      ) {
                        router.push(`/`);
                      } else {
                        location.href = `/game/${parseInt(id || '0') + 1}`;
                      }
                    },
                  }}
                />
