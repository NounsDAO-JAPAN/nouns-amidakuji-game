...
contract NounsAmidakujiSBT is ERC721, ERC721Enumerable, Ownable {
  AmidakujiInterface amidakujiContract;

  constructor() ERC721("NounsAmidakujiSBT", "NASBT") {}
  ...
  function _atariSVG(uint256 _x) internal pure returns (string memory) {
    return string(abi.encodePacked('<text x="', Strings.toString(_x), '" y="680" font-size="32">&#x1f451;</text>'));
  }
